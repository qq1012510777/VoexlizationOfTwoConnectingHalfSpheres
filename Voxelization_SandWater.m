...
If_use_Large_field_data = 0; % 0 for turn off the use of large field data (nas); 1 for turn on the use

small_field_data_width = 8; % works only if If_use_Large_field_data == 0
...
if (If_use_Large_field_data > 0)
    ...
    for i = 1:NUMVertices %size(Vpoints, 1)
        disp(['write points (large field): ', num2str(i), '/', num2str(NUMVertices)]);
...
elseif (If_use_Large_field_data == 0)
    ...
    for i = 1:NUMVertices
        ...
        fprintf(fid, '%-8s%-8s%-8s%8s%8s%8s\n', 'GRID', num2str(i, small_field_data_width), '', ...
            Num2Str_Set_Width(Vpoints(i, 1), small_field_data_width), ...
            Num2Str_Set_Width(Vpoints(i, 2), small_field_data_width), ...
            Num2Str_Set_Width(Vpoints(i, 3), small_field_data_width));
    end
...
if (If_use_Large_field_data > 0)
    ...
    for j = 1:size(sandcubeNO, 1)
        i = sandcubeNO(j);
        disp(['write sand cubes (large field): ', num2str(j), '/', num2str(size(sandcubeNO, 1))]);
...
elseif (If_use_Large_field_data == 0)
    ...
    for j = 1:size(sandcubeNO, 1)
        i = sandcubeNO(j);
        disp(['write sand cubes (small field): ', num2str(j), '/', num2str(size(sandcubeNO, 1))]);

        fprintf(fid, '%-8s%-8s%-8s%8s%8s%8s%8s%8s%8s+CONT\n', 'CHEXA', ...
            num2str(gy, small_field_data_width), ...
            '1', ...
            num2str(structure___cube(i, 1), '%8d'), ...
            num2str(structure___cube(i, 4), '%8d'), ...
            num2str(structure___cube(i, 3), '%8d'), ...
            num2str(structure___cube(i, 2), '%8d'), ...
            num2str(structure___cube(i, 5), '%8d'), ...
            num2str(structure___cube(i, 8), '%8d'));

        fprintf(fid, '%-8s%8s%8s\n', '+CONT', ...
            num2str(structure___cube(i, 7), '%8d'), ...
            num2str(structure___cube(i, 6), '%8d'));
        gy = gy + 1;
    end
...
if (If_use_Large_field_data > 0)
    ...
    for j = 1:size(cube_3_i, 1)
        disp(['write water cubes (large field): ', num2str(j), '/', num2str(size(cube_3_i, 1))]);
        i = cube_3_i(j);
...
elseif (If_use_Large_field_data == 0)
    ...
    for j = 1:size(cube_3_i, 1)
        i = cube_3_i(j);
        disp(['write water cubes (small field): ', num2str(j), '/', num2str(size(sandcubeNO, 1))]);
